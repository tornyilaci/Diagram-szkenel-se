...
class FlowchartDetection:
    ...
    def __init__(self, IMAGE_NAME, MODEL_NAME='folyamábra.png'):
        self.MODEL_NAME = MODEL_NAME
        self.IMAGE_NAME = 'images/test/' + IMAGE_NAME
        self.CWD_PATH = os.getcwd()
        self.PATH_TO_CKPT = os.path.join(self.CWD_PATH, 'models', 'research', 'object_detection', self.MODEL_NAME,
                                         'frozen_inference_graph.pb')
        self.PATH_TO_LABELS = os.path.join(self.CWD_PATH, 'models', 'research', 'object_detection', 'training',
                                           'flowchart_label_map.pbtxt')
